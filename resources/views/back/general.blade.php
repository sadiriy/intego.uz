                    ...
                    <form class="form_style" action="{{ route('general.store') }}" method="post"
                        ...
                        <div class="modal-body" style="text-align: left;">
                            <div class="input-group input-group-sm">
                                <label style="margin-bottom: 10px;">Отдел оптовых продаж</label>
                                <input name="phone" id="phone" type="text" class="form-control" value="{{ $general->phone }}">
                            </div>
                            <div class="input-group input-group-sm">
                                <label style="margin-bottom: 10px;">Сервис и поддержка</label>
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <figure>
                                    <img width="220px" height="auto" id="image-icon" src="/{{ $general->logo }}">
                                </figure>
                            </div>
{{--                            <div class="input-group input-group-sm">--}}
