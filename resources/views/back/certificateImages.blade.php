...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="border: none; padding: 20px;">
                ...
                <form class="form_style" action="{{ route('certificateImages.upload', $certificate_id) }}" method="post"
    ...
    <div class="container" align="center">
        <div class="starter-template">
            <h1>Управление фотографию сертификатов</h1>
            <div class='edit-opr'>
                <div class='container'>
                    <div class='row'>
                        <div class='col'></div>
                        ...
                        <div class='col' style='text-align: right; margin-right: 20px;'>
                            <a title="Добавить фотографию" href='' type="button" data-bs-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <img width="70px" height="auto"
                                         src="{{ asset($certificateImage->path) }}">
                                </td>
                                <td class="text-center">
                                    <form method="POST" action="{{ route('certificateImages.delete' , $certificateImage) }}"
                                          style="display: inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" title="Удалить фотографию"
                                                onclick="return confirm('Вы точно хотите удалить фотографию в сертификате?')"
